...
alias gtags='find . -type f -iregex ".*\.js$" -not -path "./node_modules/*" -exec jsctags {} -f --fields=+l \; | sed "/^$/d" | sort > tags'
alias node7.6="~/sync/bin/node-v7.6.0-darwin-x64/bin/node --debug-brk"
alias mynode="~/sync/bin/node-v7.6.0-darwin-x64/bin/node"
alias mongodb_start="mongod --config /usr/local/etc/mongod.conf"
alias chrome_db="/Applications/Google Chrome.app/Contents/MacOS/Google Chrome --remote-debugging-port=9222"
#alias verdaccio_on ="npm set registry https://verdaccio.projektionisten.de"
#alias verdaccio_off="npm config set registry https://registry.npmjs.org/"
